...
public class Stack<T> {
    ...
    /**
     * Constructor creates an array with initial size of 1064 for array and sets
     * the pointer to index 0
     */
    public Stack() {
    ...
    /**
     * Adds an object to the top of stack. If array used in stack is full then
     * a new array with double the size is created and values from old array are
     * copied to new.
    ...
    /**
     * Pops the object on top of the stack and decreases pointer by one,
